...
<html lang="en"> 
  <head>
    ...
    <link href="build/css/custom.css?time=1599465526" rel="stylesheet"/>
...
footer {
  ...
  background: #2B6454 }
   ...
   .company_name_navbar{
        text-align: left; font-size: 25px; padding: 10px;
    }
    .user-profile img{
        width: 15px;
        height: 15px;
...
.table-bordered > thead > tr > th, .table-bordered > tbody > tr > th, .table-bordered > tfoot > tr > th, .table-bordered > thead > tr > td, .table-bordered > tbody > tr > td, .table-bordered > tfoot > tr > td{
   ...
   /* Larger than mobile */
    ...
    .language_menu_nav_bar{
        display: none;        
    }
    .billing_nav_topbar_span{
        display:  none;
    }
    div.x_panel{
        margin-top: 18%;
    ...
    .profile_settings_dropdown_meun{
        right: 0 !important;
        left: -9% !important;
    }
    
    .client_details_invoice{
        width: 50px;
    }
    .login_form_box{
        position: relative;
    ...
    .new_receive_btn:hover{
        background: none;
    }
    .new_expense_btn:hover{
        background: none;
    }
    .company_name_navbar{
        padding: 0px;
    ...
    .stock_warning_dropdown_container{
        left: -355% !important;
    }
    ...
    a.btn-success:hover, a.btn-primary:hover, a.btn-warning:hover, a.btn-danger:hover{
        background: none;
    }
    ...
    @media (max-width: 1000px) {
       ...
       .new_bill_btn{
        padding: 2px !important; line-height: 10px !important; top: 12px;
       }
       .new_receive_btn{
        padding: 2px !important; line-height: 10px !important; top: 12px;
       }
...
div.selectize-dropdown div.option{
    cursor: pointer;
}
              ...
              <div class="nav toggle">
                ...
                <li>
                  <a style="color: white;"  class="new_expense_btn btn btn-danger btn-sm" data-toggle="modal" data-target="#new_expense_modal_shortcut"><img src="icon/2budget.png" width="20" /><span class="new_expense"> New Expense <i class="fa fa-plus-square"></i></span></a>  
                      ...
                      <li><a href="bangla/dashboard2.php">বাংলা</a></li>
...
-->
                    <li><a href="logout.php"><i class="fa fa-sign-out"></i> Logout</a></li>
                       ...
                       <span class="stock_expire_modal_trigger" data-toggle="modal" data-target="#stock_expire_modal"> </span>
          <div id="stock_expire_modal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                                ...
                                <thead>
                                    <tr style="background-color: #6D6357;">
                ...
                <td class="text-center">
                    <a href="pur_product.php?pid=101">
                   L25 
                    </a> 
                    <input type="hidden" id="stockqty" value="0">   
                </td>
                <td class="text-center">Symphony </td>
                <td class="text-center">9</td>
                <td class="text-center"><span style="color:red">0</span></td>
            </tr>
                    <tr>
                                            
                <td class="text-center">
                    <a href="pur_product.php?pid=100">
                   B12+ 
                    </a> 
                    <input type="hidden" id="stockqty" value="0">   
                </td>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
           ...
           <script type="text/javascript">
            $('.stock_expire_modal_trigger').click();
           </script>
    <style>
    .font-bold{
        font-size: 18px;
        ...
        <div class="right_col" role="main">
          <!-- top tiles -->
           ...
           <div class="col-md-3 col-sm-12 dashboard_info_boxes" style="background-color: #4682B4; border-radius: 2px; width: 250px; margin-right: 20px;">
                <div class="col-xs-3">
                    <img style="padding: 10px 0 0 0;" src="icon/bill.png" width="50" />
                </div>
                <div style="color: white;" class="col-xs-9">
                    
                    <h3 class="font-bold">$&nbsp;74,788.57</h3>
                ...
                <div class="col-md-3 col-sm-12 dashboard_info_boxes" style="background-color: #008080; border-radius: 2px; width: 250px; margin-right: 20px;">
                <div class="col-xs-3">
                    <img src="icon/income.png" width="50" style="padding-top: 10px;" />
                </div>
                <div style="color: white;" class="col-xs-9">
                   
                   <h3 class="font-bold">$&nbsp;65,514,166.00</h3>
                    <span style="font-size: 17px;">   Total Receive </span>
                    
                    
                </div>
                </div>
                
                <div class="col-md-3 col-sm-12 dashboard_info_boxes" style="background-color: #ED5565; border-radius: 2px; width: 250px; margin-right: 20px;">
                <div class="col-xs-3">
                    <img style="padding-top: 10px;" src="icon/2budget.png" width="50" />
                </div>
                <div style="color: white;" class="col-xs-9">
                    
                    <h3 class="font-bold">$&nbsp;56,375.00</h3>
                    
                    <span style="font-size: 17px;">Total Expenses</span>
                ...
                <div class="col-md-3 col-sm-12 dashboard_info_boxes" style="background-color: #CD5C5C;  border-radius: 2px; width: 250px;">
                <div class="col-xs-3">
                    <img src="icon/conversion.png" width="50" style="padding-top: 10px;" />
                </div>
                <div style="color: white;" class="col-xs-9">
                    
                    <h3 class="font-bold">$&nbsp;-65,439,377.43</h3>
                        
                    <span style="font-size: 17px;">  Total Due </span>
            ...
            <div class="col-md-3 col-sm-12 dashboard_info_boxes" style="background-color: #FF2C43;  border-radius: 2px; width: 250px; margin-right: 20px;">
                <div class="col-xs-3">
                    <img src="icon/shopping.png" width="50" style="padding-top: 10px;" />
                </div>
                <div style="color: white;" class="col-xs-9">
                    
                    <h3 class="font-bold">$&nbsp;0.00</h3>
                        
                    <span style="font-size: 17px;">Today Sales</span>
                    
                    
                </div>
                </div>
            
             <div class="col-md-3 col-sm-12 dashboard_info_boxes" style="background-color: #822CFF; border-radius: 2px; width: 250px; margin-right: 20px;">
                <div class="col-xs-3">
                    <img style="padding: 10px 0 0 0;" src="icon/income-1.png" width="50" />
                </div>
                <div style="color: white;" class="col-xs-9">
                    
                    <h3 class="font-bold">$&nbsp;0.00</h3>
                        <span style="font-size: 17px;">Today Received</span>
                    
                </div>
                
                </div>
                
                <div class="col-md-3 col-sm-12 dashboard_info_boxes" style="background-color: #2CA2FF; border-radius: 2px; width: 250px; margin-right: 20px;">
                <div class="col-xs-3">
                    <img src="icon/1budget.png" width="50" style="padding-top: 10px;" />
                </div>
                <div style="color: white;" class="col-xs-9">
                   
                   <h3 class="font-bold">$&nbsp;0.00</h3>
                    <span style="font-size: 17px;"> Today Expenses </span>
                    
                    
                </div>
                </div>
                
                <div class="col-md-3 col-sm-12 dashboard_info_boxes" style="background-color: #FF892C; border-radius: 2px; width: 250px;">
                <div class="col-xs-3">
                    <img style="padding-top: 10px;" src="icon/balance1.png" width="50" />
                </div>
                <div style="color: white;" class="col-xs-9">
                    
                    <h3 class="font-bold">$&nbsp;0.00</h3>
                    
                    <span style="font-size: 17px;"> Today Balance </span>
            ...
            <div class="col-md-3 col-sm-12 dashboard_info_boxes" style="background-color: #b0574d;  border-radius: 2px; width: 250px; margin-right: 20px;">
                <div class="col-xs-3">
                    <img src="icon/booking.png" width="50" style="padding-top: 10px;" />
                </div>
                <div style="color: white;" class="col-xs-9">
                    
                    <h3 class="font-bold">$&nbsp;6,836.00</h3>
                        
                    <span style="font-size: 17px;">September Sales</span>
                    
                    
                </div>
                </div>
            
             <div class="col-md-3 col-sm-12 dashboard_info_boxes" style="background-color: #41894d; border-radius: 2px; width: 250px; margin-right: 20px;">
                <div class="col-xs-3">
                    <img style="padding: 10px 0 0 0;" src="icon/booking.png" width="50" />
                </div>
                <div style="color: white;" class="col-xs-9">
                    
                    <h3 class="font-bold">$&nbsp;6,370.00</h3>
                        <span style="font-size: 17px;">September Received</span>
                    
                </div>
                
                </div>
                
                <div class="col-md-3 col-sm-12 dashboard_info_boxes" style="background-color: #873b51; border-radius: 2px; width: 250px; margin-right: 20px;">
                <div class="col-xs-3">
                    <img src="icon/booking.png" width="50" style="padding-top: 10px;" />
                </div>
                <div style="color: white;" class="col-xs-9">
                   
                   <h3 class="font-bold">$&nbsp;56,000.00</h3>
                    <span style="font-size: 17px;"> September Expenses </span>
                    
                    
                </div>
                </div>
                
                <div class="col-md-3 col-sm-12 dashboard_info_boxes" style="background-color: #00688B; border-radius: 2px; width: 250px;">
                <div class="col-xs-3">
                    <img style="padding-top: 10px;" src="icon/booking.png" width="50" />
                </div>
                <div style="color: white;" class="col-xs-9">
                    
                    <h3 class="font-bold">$&nbsp;-49,630.00</h3>
                    
                    <span style="font-size: 17px;"> September Balance </span>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                ...
                <canvas id="horizontal_week_view_sales" style="height: 300px; width: 100%;"></canvas>
                <script>
                    ...
                    var horizontal_myBarChart = new Chart(horizontal_week_view_sales, {
                                type: 'horizontalBar',
                                data: {
                                    labels: ["7 Sep","6 Sep","5 Sep","4 Sep","3 Sep","2 Sep","1 Sep"],
                                    datasets: [{
                                        label: 'Sales',
                                        data: [0,0,290,1409.5,850,889.5,1100],
                                        backgroundColor: ["rgba(5, 232, 96, 0.4)","rgba(16, 134, 74, 0.4)","rgba(219, 108, 158, 0.4)","rgba(13, 103, 118, 0.4)","rgba(119, 176, 48, 0.4)","rgba(18, 54, 236, 0.4)","rgba(44, 224, 70, 0.4)"],
                                        borderColor: ["rgba(122, 31, 251, 1)","rgba(233, 157, 68, 1)","rgba(94, 13, 216, 1)","rgba(98, 189, 59, 1)","rgba(170, 29, 172, 1)","rgba(159, 100, 143, 1)","rgba(173, 157, 220, 1)"],
                                        borderWidth: 1
                                    }]
                                },
                                options: {
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                ...
                <canvas id="horizontal_week_view_receive" style="height: 300px; width: 100%;"></canvas>
                <script>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                ...
                <canvas id="horizontal_week_view_expense" style="height: 300px; width: 100%;"></canvas>
                <script>
           ...
           <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <canvas id="sales_amount_bar_chart" style="height: 300px; width: 100%;"></canvas>
                        <script>
                        ...
                        var sales_amount_bar_display = new Chart(sales_amount_bar_chart, {
                            type: 'bar',
                            data: {
                                labels: [ '1 Sep 2020','2 Sep 2020','3 Sep 2020','4 Sep 2020','5 Sep 2020',  ],
                                datasets: [{
                                    label: 'Sales',
                                    data: ['1265','18768.06','850','1409.5','1414.8',],
                                    backgroundColor: [
                                    'rgba(103, 128, 173, 0.5)','rgba(228, 86, 250, 0.5)','rgba(38, 147, 14, 0.5)','rgba(224, 77, 216, 0.5)','rgba(142, 46, 60, 0.5)',                                     
                                    ],
                                    borderColor: [
                                    'rgba(115, 48, 74, 1)','rgba(212, 196, 99, 1)','rgba(50, 170, 181, 1)','rgba(209, 206, 144, 1)','rgba(191, 153, 248, 1)',                                     
                                    ],
                                    borderWidth: 1
                                }]
                            },
           ...
           <div class="row">
            <div class="col-md-12">
                <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <canvas id="top_products_items_sold" style="height: 300px; width: 100%;"></canvas>
                        <script>
                        var top_products_items_sold = document.getElementById('top_products_items_sold');
                        var top_products_items_sold_display = new Chart(top_products_items_sold, {
                            type: 'bar',
                            data: {
                                labels: [ '','','','','','','','','','',  ],
                                datasets: [{
                                    label: 'Items Sold',
                                    data: ['2002','20','15','12','10','9','6','3','1','-1', ],
                                    backgroundColor: [
                                     'rgba(90, 217, 84, 0.5)','rgba(250, 176, 205, 0.5)','rgba(37, 202, 93, 0.5)','rgba(241, 96, 102, 0.5)','rgba(17, 111, 113, 0.5)','rgba(238, 27, 146, 0.5)','rgba(62, 161, 58, 0.5)','rgba(184, 125, 215, 0.5)','rgba(147, 95, 178, 0.5)','rgba(74, 181, 58, 0.5)', 
                                    ],
                                    borderColor: [
                                    'rgba(58, 196, 109, 0.5)','rgba(114, 216, 172, 0.5)','rgba(152, 48, 65, 0.5)','rgba(210, 117, 219, 0.5)','rgba(24, 5, 40, 0.5)','rgba(160, 33, 1, 0.5)','rgba(139, 214, 166, 0.5)','rgba(213, 176, 95, 0.5)','rgba(23, 132, 157, 0.5)','rgba(188, 230, 71, 0.5)', 
                                    ],
                                    borderWidth: 1
                                }]
                            },
          ...
          <div class="col-lg-5 col-md-5 col-sm-5">
                                        ...
                                        <canvas id="receive_amount_bar_chart" style="height: 300px; width: 100%;"></canvas>
                        <script>
                        var receive_amount_bar_chart = document.getElementById('receive_amount_bar_chart');
                        var receive_amount_bar_display = new Chart(receive_amount_bar_chart, {
                            type: 'bar',
                            data: {
                                labels: [ '17 Aug 2020','18 Aug 2020','19 Aug 2020','20 Aug 2020','22 Aug 2020','25 Aug 2020','26 Aug 2020','27 Aug 2020','28 Aug 2020','29 Aug 2020','30 Aug 2020','31 Aug 2020','1 Sep 2020','2 Sep 2020','5 Sep 2020',  ],
                                datasets: [{
                                    label: 'Receive Amount',
                                    data: ['3310','12500','3330','32000','200','65410565','7','1340','831','36100','7113','500','500','4810','1060',],
                                    backgroundColor: [
                                    'rgba(137, 177, 28, 0.5)','rgba(180, 10, 55, 0.5)','rgba(167, 21, 243, 0.5)','rgba(196, 227, 58, 0.5)','rgba(29, 33, 13, 0.5)','rgba(75, 86, 111, 0.5)','rgba(48, 39, 237, 0.5)','rgba(105, 108, 161, 0.5)','rgba(213, 171, 57, 0.5)','rgba(31, 27, 243, 0.5)','rgba(21, 95, 219, 0.5)','rgba(119, 173, 251, 0.5)','rgba(170, 129, 127, 0.5)','rgba(196, 199, 39, 0.5)','rgba(93, 212, 32, 0.5)',                                     
                                    ],
                                    borderColor: [
                                    'rgba(89, 124, 61, 1)','rgba(25, 232, 232, 1)','rgba(185, 4, 119, 1)','rgba(122, 156, 219, 1)','rgba(214, 39, 125, 1)','rgba(180, 141, 161, 1)','rgba(112, 32, 33, 1)','rgba(118, 254, 207, 1)','rgba(159, 215, 223, 1)','rgba(79, 249, 176, 1)','rgba(18, 51, 69, 1)','rgba(221, 69, 231, 1)','rgba(171, 185, 15, 1)','rgba(150, 227, 124, 1)','rgba(199, 52, 242, 1)',                                     
                                    ],
                                    borderWidth: 1
                                }]
                            },
          ...
          <div class="col-lg-5 col-md-5 col-sm-5">
                                        ...
                                        <canvas id="expense_amount_bar_chart" style="height: 300px; width: 100%;"></canvas>
                        <script>
                        var expense_amount_bar_chart = document.getElementById('expense_amount_bar_chart');
                        var expense_amount_bar_display = new Chart(expense_amount_bar_chart, {
                            type: 'bar',
                            data: {
                                labels: [ '25 Aug 2020','27 Aug 2020','2 Sep 2020',  ],
                                datasets: [{
                                    label: 'Expense Amount',
                                    data: ['25','350','56000',],
                                    backgroundColor: [
                                    'rgba(151, 15, 226, 0.5)','rgba(239, 30, 105, 0.5)','rgba(135, 124, 131, 0.5)',                                     
                                    ],
                                    borderColor: [
                                    'rgba(53, 70, 77, 1)','rgba(202, 147, 109, 1)','rgba(99, 104, 69, 1)',                                     
                                    ],
                                    borderWidth: 1
                                }]
                            },
   ...
   <br />
          ...
          <canvas id="dognut2" style="height: 300px; width: 100%;"></canvas>
          <script type="text/javascript">
          var dognut = document.getElementById('dognut');
          var myPieChart = new Chart(dognut, {
                type: 'pie',
                data: {
                        datasets: [{
                            data: [10, 20, 30],
                            backgroundColor: ['cyan','magenta','brown']
                        }],
                        labels: [
                            'data1',
                            'data2',
...
<option style="color: black; font-size: 16px;" value="108" >rahim ()</option>
...
<option style="color: black; font-size: 16px;" value="116" >Md Ashraful Islam ()</option>

        
                
<option style="color: black; font-size: 16px;" value="117" >hello ()</option>

        
                
<option style="color: black; font-size: 16px;" value="118" >Nahid ()</option>
    ...
    <div class="col-md-8 col-sm-6 col-xs-12 deposit_category_container">
      ...
      <option></option>
               <option value="10">top up</option>
                ...
                <option value="12">Comission</option>
                           
                <option value="13">rokon</option>
  ...
  <script type="text/javascript">
    $(function(){
        $('.deposit_category').on('change',function(){
           ...
           $.post('get_income_subcategory.php',{deposit_category:deposit_category}).always(function(deposit_sub_data){
  ...
  <script type="text/javascript">
    $(function(){
       $('.expense_category_select').on('change',function(){
            ...
            $.post('get_expense_subcategory.php',{expense_id:expense_id}).always(function(expense_sub_data){
...
<script>
  ...
  let file = new Blob([$('.divclass').php()], {type:"application/vnd.ms-excel"});
...
<!-- footer content -->
        <footer>
          <div class="pull-right">
                                      © 2017-2020 All Rights Reserved. : <a target="_blank" href="http://hubit.tech/">HUB IT</a> V 2.0
...
$( ".datepickerMinDate" ).datepicker({ inline: true, minDate: +1 });
$( ".datepickerMaxDate" ).datepicker({ inline: true, maxDate: 0 });
...
$(function(){
   $('.account_list_select').on('change',function(){
        var id = $(this).val();
        $.post('account_bl_ajax.php',{id:id}).always(function(data){
