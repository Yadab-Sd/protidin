...
<div class="container">
  <div style="margin: 10%;">
      ...
      <div class="col-sm-10">
        ...
        <select autocomplete="OFF" type="text" class="form-control" id="product" name="product">
          <option></option>
          <option value="Mango 1 Kg">Mango 1 Kg</option>
          <option value="Orange 1 Kg">Orange 1 Kg</option>
